...
conventional_df=pd.read_csv("../conventional.tsv",sep="\t",columns=columns)
novel_df=pd.read_csv("../novel.tsv",sep="\t",columns=columns)
literals_df=pd.read_csv("../literals.tsv",sep="\t",columns=columns)
